...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
            ...
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  <item.icon
                    className={`${
                      isActive ? 'text-[#4AA8FF]' : 'text-gray-400 group-hover:text-gray-500'
  ...
  function getNotificationCount(page: string) {
    switch (page.toLowerCase()) {
      case 'merchants': return notificationCounts.merchants;
      case 'franchises': return notificationCounts.franchises;
      case 'ecommerce': return notificationCounts.ecommerce;
      case 'transactions': return notificationCounts.transactions;
      case 'feedback': return notificationCounts.feedback;
      default: return 0;
    }
  }
}